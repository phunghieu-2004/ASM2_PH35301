            ...
            <div class="swiper-container">
              <div class="swiper-wrapper">
                <div class="swiper-slide product-single__image-item" style="margin-top: 100px;">
                  <img loading="lazy" class="h-auto" src="{{asset($product['img_thumbnail'])}}" width="674" height="674" padding-top=100px alt="">
          ...
          <div class="product-single__reviews-list">
            <div class="product-single__reviews-item">
              <div class="customer-avatar">
                <img loading="lazy" src="{{ asset('assets/client/images/avatar.jpg') }}" alt="">
              </div>
